...
import {SkipInterceptor, WriteObject} from "./backend.interceptor";
...
export class AuthService {
   ...
   private url = environment.user_r;
    ...
    getCurrentAuthState(): boolean {
      ...
      async createUser(userData: UserModel){
        ...
        this.httpClient.post(`${this.serverUrl}/customers`, {...userData}, {headers})
            .subscribe(async () => {
                await loader.dismiss().then();
